...
//4.15 Full Location name
function HTML_FullLocationName(locationId) {
    for (var i = 0; i < cities.length; i++) {
        if (cities[i].id == locationId) {
            var result = cities[i].title_ru + " - " + cities[i].title_nt + " - " + cities[i].title;
            break;
        }
    }
    return result;
...
function HTML_ShortLocationName(locationId) {
    for (var i = 0; i < cities.length; i++) {
        if (cities[i].id == locationId) {
            var result = cities[i].title_ru;
            break;
        }
    }
    return result;
